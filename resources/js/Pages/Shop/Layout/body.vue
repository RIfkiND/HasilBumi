<template>
  ...
  <!-- <div class="container py-4 flex items-center gap-3">
    ...
    <span class="text-dark ml-2 font-medium">Shop</span>
    </span>
</div> -->
  ...
  <div class="container grid md:grid-cols-4 grid-cols-2 gap-6 pt-4 pb-16 items-start">
    ...
    >
      <h5
        id="drawer-label"
        class="inline-flex items-center mb-4 text-base font-semibold text-dark"
      >
        <svg
          class="w-5 h-5 mr-2"
          aria-hidden="true"
      ...
      >
        ...
        <span class="text-pink">Close menu</span>
      </button>
      <div class="divide-y divide-dark space-y-5">
        <div>
          <h3 class="text-xl text-dark mb-3 capitalize font-medium pt-3">Categories</h3>
          <div class="space-y-2">
            <div class="flex items-center">
              ...
              <div class="ml-auto text-gray-600 text-sm">&lpar; 15 &rpar;</div>
            </div>
            <div class="flex items-center">
              <input
                type="checkbox"
                name="cat-2"
                id="cat-2"
                class="text-primaryColor focus:ring-0 rounded-sm cursor-pointer"
              />
              <label for="cat-2" class="text-gray-600 ml-3 cusror-pointer">Sofa</label>
              <div class="ml-auto text-gray-600 text-sm">&lpar; 9 &rpar;</div>
            </div>
            <div class="flex items-center">
              <input
                type="checkbox"
              ...
              <div class="ml-auto text-gray-600 text-sm">&lpar; 21 &rpar;</div>
            </div>
            <div class="flex items-center">
              <input
                type="checkbox"
              ...
              <div class="ml-auto text-gray-600 text-sm">&lpar; 20 &rpar;</div>
            </div>
          </div>
        </div>
          ...
          <div class="space-y-2">
            ...
            <div class="flex items-center">
              ...
              <label for="brand-5" class="text-gray-600 ml-3 cusror-pointer"
                >Olympic</label
              >
              <div class="ml-auto text-gray-600 text-sm">&lpar; 10 &rpar;</div>
            </div>
          </div>
        </div>
    ...
    >
      <div class="divide-y divide-gray-200 space-y-5">
        ...
        <div class="pt-4">
          <h3 class="text-xl text-gray-800 mb-3 uppercase font-medium">Satuan</h3>

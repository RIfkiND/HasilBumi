<template>
    ...
    >
        ...
        <div>
            ...
            <div class="mt-4">
                <h3 class="text-sm text-dark capitalize font-semibold">
                    Quantity
                </h3>
                <div class="flex">
                    <button
    ...
    <!-- shop -->
    <div
        class="flex items-center py-7 border-2 border-white-50 px-32 mb-10 rounded-md"
    >
        ...
        <div class="flex gap-7">
            <div class="space-y-1 ml-3 border-r-2 pr-10 border-white-50">
                <div class="flex">
                    <div class="block -space-y-1">
                        ...
                        <div v-else>
                            <span class="text-primaryColor text-left"
                                >Online</span
                            >
                        </div>
                        <div class="flex">
            ...
            <div class="space-y-5 border-r-2 pr-10 border-white-50">
                <div class="flex justify-between gap-5 mt-4">
                    <label class="text-slate-200 capitalize"

<template>
    ...
    <div class="container flex items-center gap-2 py-4 mt-5 text-sm font-inter">
      ...
      <Link :href="route('Shop.main')">
        <span class="font-medium text-slate-200 hover:text-slate-300">Shop</span>
      </Link>
      <span class="text-sm text-slate-200">
        <i class="fa-solid fa-chevron-right"></i>
      </span>
    ...
    >
      ...
      <div>
        <h2 class="mb-3 text-3xl font-bold capitalize sm:text-sm md:text-md lg:text-4xl">
          {{ detailProduct.name }}
        </h2>
        <div class="flex items-center mb-4">
          <div class="flex text-sm divide-x-2 text-primaryColor divide-white-50">
            ...
            <div class="grid grid-cols-2 gap-2 text-center">
              <span class="text-sm text-center capitalize mt-1/2 text-dark">
                <Link
              ...
              <div class="text-center border-l-2 border-white-50">
                <span class="text-sm capitalize text-dark">26rb terjual</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="flex items-baseline mt-4 mb-1 space-x-2 font-roboto">
          <p class="text-xl font-semibold text-primaryColor">Rp{{ detailProduct.price }}</p>
        </div>
        ...
        <div class="mt-4">
          <h3 class="text-sm font-semibold capitalize text-dark">Quantity</h3>
          <div class="flex">
            <button
              v-if="count >= 1"
              @click="decrement"
        ...
        <div class="flex gap-3 pt-3 pb-5 mt-6">
          ...
          >
            ...
            <span class="outline-none group-hover:text-white">Tambahkan ke keranjang</span>
          </a>
        </div>
      </div>
    </div>
    ...
    <div class="flex items-center px-32 mb-10 border-2 rounded-md py-7 border-white-50">
      ...
      <div class="flex gap-7">
        <div class="pr-10 ml-3 space-y-1 border-r-2 border-white-50">
          <div class="flex">
            <div class="block -space-y-1">
              ...
              <div v-else>
                <span class="text-left text-primaryColor">Online</span>
              </div>
              <div class="flex">
                <div class="space-x-1">
                  <span
          ...
          <div class="flex gap-2">
            ...
            <Link
              :href="route('seller.store', detailProduct.seller.nama_toko)"
        ...
        <div class="pr-10 space-y-5 border-r-2 border-white-50">
          <div class="flex justify-between gap-5 mt-4">
            <label class="capitalize text-slate-200">Presentasi chat dibales</label>
                ...
                >
                  <thead class="text-slate-300">
                    <tr class="text-sm capitalize">
                      <th scope="col" class="px-4 py-2 font-semibold">nama produk</th>
                      <th scope="col" class="px-4 py-2 font-semibold">
                        harga &#40;Rp&#41;
                      </th>
                      <th scope="col" class="px-4 py-2 font-semibold">rating</th>
                      <th scope="col" class="px-4 py-2 font-semibold">ulasan</th>
                      <th scope="col" class="px-4 py-2 font-semibold">
                        kebijakan pengembalian
                      </th>
                      <th scope="col" class="px-4 py-2 font-semibold">satuan</th>
                    </tr>
                  </thead>
                  <tbody class="">
    ...
    <!-- related product -->
    <div class="container pb-16 font-inter">
      <h2 class="mb-6 text-2xl font-medium capitalize text-dark">produk lainnya</h2>
      <!-- Show produk -->
      <div class="grid grid-cols-2 gap-3 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5">
        ...
        >
          ...
          <div class="flex items-center pb-3 space-x-2 divide-x-2 divide-white-50">
            ...
            <div class="flex gap-1 px-2 ml-3 text-xs text-center capitalize text-slate-300">
              <svg

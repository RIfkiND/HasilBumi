  ...
  <div>
    ...
    <div class="flex items-center justify-center min-h-screen bg-white font-inter">
      ...
      >
          ...
          <form @submit.prevent="handleLogin">
            <div class="py-2">
              ...
              <input
                ...
                autocomplete="false"
              />
              <span class="text-pink text-md hidden peer-invalid:block my-2"
        ...
        <!-- right side -->
        <div class="relative items-center flex mr-10">
          <img
            src="Assets/img/ilustration/ilustration1.png"
            alt="Petani Memetik Buah"
            class="w-full h-[400px] hidden rounded-r-2xl md:block object-cover"
            loading="lazy"
          />
        </div>
      </div>

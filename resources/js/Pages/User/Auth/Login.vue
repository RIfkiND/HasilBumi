<template>
    <div>
        ...
        <div
            class="flex items-center justify-center min-h-screen bg-white font-inter"
        >
            <div
            ...
            >
                <Link
                    :href="route('Home')"
                    class="no-underline float-left mx-2 my-5 left-1 absolute"
                >
                    <div
                ...
                <div class="flex flex-col justify-center p-8 md:p-12 mx-4">
                    <span class="mb-2 text-4xl font-bold text-textColor"
                        >Login</span
                    >
                    ...
                    <form @submit.prevent="handleLogin">
                        <div class="py-2">
                            <label
                                for="email"
                                class="mb-2 text-md text-textColor"
                            ...
                            />
                            <span
                                class="text-pink text-md hidden peer-invalid:block my-2"
                    ...
                    <span class="text-center text-xs text-gray-300 mb-3"
                        >Or</span
                    >
                    <button
                    ...
                    >
                        ...
                        <a
                            ...
                            class="text-md text-dark text-decoration-none"
                    ...
                    <div class="text-center text-gray-400">
                        ...
                        <span
                            ><Link
                                ...
                                class="text-textColor text-decoration-none hover:text-teal hover:cursor-pointer"
                                >Sign up</Link
                            ></span
                        >
                    </div>
...
const handleLogin = async () => {
    try {
        await router.post(route('auth.login'));
    } catch (error) {
        console.log(error)
    }
}

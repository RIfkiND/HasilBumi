...
<template>
    <footer class="bg-white font-inter selection:text-white selection:bg-dark">
        ...
        >
            ...
            <div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
                <div>
                    ...
                    <hr class="text-slate-200 rounded-md" />
                    <div class="gap-3 mt-5">
                        <p class="text-dark font-bold">Penghargaan</p>
                        <br />
                        <div class="block">
                ...
                <div
                    class="grid grid-cols-1 gap-10 sm:grid-cols-2 lg:col-span-2 lg:grid-cols-4"
                >
                    <div>
                        <p class="text-dark font-bold">Tautan Navigasi</p>

                        <ul class="mt-6 pl-0 space-y-4 text-sm">
                            <li>
                                <a
                                    href="#"
                    ...
                    <div>
                        <p class="font-bold text-dark">Company</p>
                        <ul class="mt-6 pl-0 space-y-4 text-sm">
                            <li>
                                <a
                                    href="#"
                    ...
                    <div>
                        <p class="font-bold text-dark">Legal</p>
                        <ul class="mt-6 pl-0 space-y-4 text-sm">
                            <li>
                                <a
                                    href="#"
                    ...
                    <div>
                        <p class="font-bold text-dark">Informasi Kontak</p>
                        <ul class="mt-6 pl-0 space-y-4 text-sm text-left">
                            <li class="">
                                <a
                                    href="#"
                                    class="text-textColor transition hover:text-primaryColor flex items-center gap-1 mb-0"
                                >
                                    <i class="bx bx-home-alt bx-xm">:</i>
                                    <span class="mb-0">Ciamis</span>
                                </a>
                            </li>
                    ...
                    <div>
                        <p class="font-bold text-dark">Gaya Bahasa</p>
                        <div>
                            <div class="relative mt-1.5">
                                ...
                                <span
                                    class="absolute inset-y-0 end-0 flex w-8 items-center right-0"
                                >
                                    <i
                                        class="bx bxs-down-arrow text-[10px] text-right text-slate-200"
                                    ></i>
                                </span>
                            </div>
        ...
        <p
            class="flex justify-center items-center text-md text-slate-200 w-full p-3 bg-white-50"
        >
            <span class="text-center mt-2">&copy; 2024. Team HasilBumi.</span>
        </p>
    </footer>
</template>

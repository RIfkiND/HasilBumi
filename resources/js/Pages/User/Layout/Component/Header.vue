...
<template>
    ...
    <div class="container flex items-center justify-evenly md:gap-4 sm:gap-6">
      ...
      <div class="flex items-center space-x-4 gap-2">
        ...
        <div class="flex gap-3 mx-5 md:flex" v-if="!$page.props.auth.user">
          ...
          <Link :href="route('view.register')" class="btn-header-full">Register</Link>
          <!-- <Link
    ...
    <div class="container flex items-center">
      ...
      <div class="flex items-center justify-between flex-grow md:pl-12 py-2">
        <div class="flex items-center space-x-6 capitalize">
          ...
          <Link :href="route('Shop.main')" class="nav-menu text-white">Shop</Link>
  ...
  >
    <div class="container">
      ...
      <div class="py-4">
        <a href="#" class="block text-white py-2 px-4 hover:bg-hoverPrimary transition">
          Home
        </a>
        <a href="#" class="block text-white py-2 px-4 hover:bg-hoverPrimary transition">
          Shop

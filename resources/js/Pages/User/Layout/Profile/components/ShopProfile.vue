<template>
  <div
    ...
    class="relative flex flex-col min-w-0 break-words w-full shadow-md rounded-lg bg-blueGray-100 border-0 font-inter"
  >
    <div class="rounded-t bg-white mb-0 px-6 py-6">
      <div class="text-center flex justify-between">
        <h6 class="text-blueGray-700 text-xl font-bold">Toko {{ $page.props.auth.seller.nama_toko }}</h6>
      </div>
    </div>
    <div class="flex-auto px-4 lg:px-10 py-10 pt-0">
      <div class="grid grid-cols-2 gap-4">
            ...
            <label class="block text-gray-700 text-sm font-bold mb-2" for="photo">
              <div class="flex justify-center items-center gap-3">
                <div v-if="!photUrl" class="avatar placeholder">
                  <div
                    class="bg-dark text-neutral-content rounded-full w-24 h-24 flex items-center justify-center"
                  >
                    <span class="text-4xl text-white"> {{ initial }}</span>
                  </div>
                </div>
        ...
        <div class="flex flex-col gap-4">
          <h3 class="font-semibold text-text-grey text-lg">Ubah Toko</h3>
          <div class="flex items-center text-sm">
            <span class="w-[114px]">Nama Toko</span>
            <span class="mr-3">{{ $page.props.auth.seller.nama_toko }}</span>
            <a
              href="#"
          ...
          <hr class="mt-6 border-b-1 w-full col-span-2 border-blueGray-300" />
          ...
          <div class="flex items-center text-sm">
            ...
            <a href="#" class="text-primaryColor hover:text-hoverPrimary font-semibold"
              ><svg
                xmlns="http://www.w3.org/2000/svg"
                class="w-6 h-6 text-blue-400"
                fill="none"
          ...
          <div class="flex items-center text-sm">
            ...
            <span class="mr-3">{{ $page.props.auth.seller.no_telp_toko }}</span>
            <a href="#" class="text-primaryColor hover:text-hoverPrimary font-semibold"
              ><svg
                xmlns="http://www.w3.org/2000/svg"
                class="w-6 h-6 text-blue-400"
    ...
    >
      <div class="bg-white p-8 rounded shadow-lg z-100 w-1/4">
        ...
        <p class="text-md text-textColor opacity-70">
          Kamu hanya dapat mengubah nama Toko 1 kali pastikan nama sudah benar
        </p>
        <form @submit.prevent="submit" class="mt-8">
          <div class="mb-4">
            <label for="name" class="block text-gray-700">Nama Toko</label>
            <input
              type="text"
              id="name"
    ...
    >
      <div class="bg-white max-w-full p-8 rounded shadow-lg z-100 w-1/3">
        <div>
          ...
          <form @submit.prevent="submit" class="mt-8">
            <div class="grid lg:grid-cols-2 gap-4 grid-cols-1 items-center">
              <div class="mb-4">
                <label
                  for="telp"
              ...
              <div class="mb-4">
                ...
                >
                  ...
                  <option value="8" selected>Jawa Barat</option>
...
const photoUrl = computed(() => {
  return (
    photoPreview.value ||
    (page.props.auth.user.avatar_user ? page.props.auth.seller.photo_toko : null)
  );
});
//~~~~~~~~~~~~~~~~~~~~~~~~imageUpload
const TokoImage = ref("");

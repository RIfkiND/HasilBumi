    ...
    <div class="flex-auto px-4 lg:px-10 py-10 pt-0">
      <div class="grid grid-cols-2 gap-4">
        ...
        <div class="flex flex-col gap-4">
          <h3 class="font-semibold text-text-grey text-lg">Ubah Biodata</h3>
          ...
          <h3 class="font-semibold text-text-grey text-lg">Ubah kontak</h3>
          <div class="flex items-center text-sm">
          ...
          <div class="flex items-center text-sm">
            <span class="w-[114px]">Nomor HP</span>
  ...
  <transition name="modal">
    ...
    >
      <div class="bg-white p-8 rounded shadow-lg z-100 w-1/3">
        ...
        <p class="text-md text-textColor opacity-70">
          Kamu hanya dapat mengatur tanggal lahir satu kali. Pastikan tanggal lahir sudah
          benar.
        </p>
        <form @submit.prevent="submit" class="mt-8">
          <div class="flex justify-evenly flex-wrap">
            <div class="mb-4">
              <label for="day" class="block text-gray-700">Hari</label>
              <select
                id="day"
  ...
  <transition name="modal">
    ...
    >
      <div class="bg-white p-8 rounded shadow-lg z-100 w-1/4">
        ...
        <form @submit.prevent="submit" class="mt-8">
          <div class="mb-4">
            <label for="gender" class="block text-gray-700">Kelamin</label>
            <select
              id="gender"
...
const years = Array.from({ length: currentYear - 1944 + 1 }, (_, i) => 1944 + i);
//form

        ...
        <div class="container mx-auto mt-12">
            <div class="max-w-7xl mx-auto flex w-[1200px] gap-10">
                <div class="flex flex-row shadow-lg justify-self-start">
                    <div
                        class="flex flex-col p-4 bg-white rounded-r-3xl overflow-hidden"
                    >
                        ...
                        <div
                            class="border-t mt-6 border-slate-200 opacity-50"
                        ></div>
                    ...
                    <div class="flex-auto px-4 lg:px-10 py-10 pt-0">
                        <form class="grid grid-cols-2 gap-4">
                            ...
                            <div class="flex flex-col gap-4">
                                <h3
                                    class="font-semibold text-text-grey text-lg"
                                >
                                    Ubah Biodata
                                </h3>
